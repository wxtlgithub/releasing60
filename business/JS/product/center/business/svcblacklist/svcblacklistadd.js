...
Js.Center.Business.SvcBlacklistAdd.func = function(){
	Js.Center.Business.SvcBlacklistAdd.GatewayStore = new Ext.data.Store({
		autoLoad:true,
	    ...
	    listeners:{
	    	load:function(){
	    		var data = this.data;
	    		var lovcomboxFile = Ext.getCmp("Js.Center.Business.SvcBlacklistAdd.gwcombo");
	    		var lovcomboxList = Ext.getCmp("Js.center.business.lovcombo.bwlist");
	    		lovcomboxFile.store.data = data;	
	    		lovcomboxList.store.data = data;	
	    	}
	    }
	});
//	Js.Center.Business.SvcBlacklistAdd.GatewayStore.reload();
	if (Js.Center.Business.SvcBlacklistAdd.window == null) {
		...
		var addByFilePanel = new Ext.form.FormPanel({
			...
			items: [{ xtype: "hidden",
                ...
                id: 'Js.Center.Business.SvcBlacklistAdd.gwcombo',
        		autoLoad:true,
        		clearOnPageLoad:true,
        		buffered:false,
                emptyText: '-=请选择=-',
...
//                readOnly: true,
                ...
                store:Js.Center.Business.SvcBlacklistAdd.GatewayStore,
                triggerAction: 'all',
                selectOnFocus: true,
